...
UtilityFunction1568825275605::getUtilityFunction(Plan *plan) {
 ...
 *
 * Transition:
 *   - Name: 1568825457853, ConditionString: MovingTask received!, Comment :
 * MISSING_COMMENT
 *
 * Plans in State:
 *
...
bool PreCondition1568825457853::evaluate(shared_ptr<RunningPlan> rp) {
  ...
  auto lastSpeechAct =
      this->wm->dialogueManager.commandHandler->getCommandActBuffer()
          .getLastValidContent();
  return lastSpeechAct.has_value() &&
         lastSpeechAct->type == control::SpeechType::command;
  /*PROTECTED REGION END*/
}
/*
 *
 * Transition:
 *   - Name: 1568825476581, ConditionString: Movement successful!, Comment :
 * MISSING_COMMENT
 *
 * Plans in State:
 *
