...
// Plan:ServeMaster
// Check of PreCondition - (Name): 1558533725689, (ConditionString): Stop
// received , (Comment) :
...
UtilityFunction1555601736192::getUtilityFunction(Plan *plan) {
 ...
 *
 * Transition:
 *   - Name: 1558533620473, ConditionString: Start received!, Comment :
 * MISSING_COMMENT
 *
 * Plans in State:
 *
 ...
 *
 * Transition:
 *   - Name: 1558533654035, ConditionString: Stop received, Comment :
 * MISSING_COMMENT
 *
 * Plans in State:
 *
 ...
 *
 * Transition:
 *   - Name: 1558533667052, ConditionString: Spawn successful (acknowledge
 * through received sim sensor values), Comment : MISSING_COMMENT
 *
 * Plans in State:
 *
 *   - Plan - (Name): Spawn, (PlanID): 1558533534825
 ...
 *
 * Transition:
 *   - Name: 1560934538125, ConditionString: Stop received!, Comment :
 * MISSING_COMMENT
 *
 * Plans in State:
 *
