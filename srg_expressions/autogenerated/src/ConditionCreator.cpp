...
std::shared_ptr<BasicCondition> ConditionCreator::createConditions(long conditionConfId)
{
    ...
    case 1573419828606:
        ...
        break;
    case 1582991323350:
        return std::make_shared<PreCondition1582991323350>();
        break;
    case 1582991345020:
        return std::make_shared<PreCondition1582991345020>();
        break;
    case 1583008562201:
        return std::make_shared<PreCondition1583008562201>();
        break;
    case 1583070277040:
        return std::make_shared<PreCondition1583070277040>();
        break;
    case 1596916629821:
        return std::make_shared<PreCondition1596916629821>();
        break;
    default:
