...
Robot::Robot(string robotName, const essentials::Identifier* robotId, RobotsControl* parentRobotsControl)
    ...
    , showProcessManager(true)
{
    ...
    this->broadcastId = new essentials::WildcardID(nullptr, 0);
...
void Robot::handleProcessStat(std::chrono::system_clock::time_point timeMsgReceived, process_manager::ProcessStat ps, const essentials::Identifier* parentPMid)
{
